...
'''Úkol B'''
#? Vypište do poznámky všechny bitové operátory, které nabízí Python - & AND, | OR, ^ XOR, ~ NOT, << bitový posun vlevo, >> bitový posun vpravo
